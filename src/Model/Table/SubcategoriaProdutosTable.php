...
class SubcategoriaProdutosTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('subcategoria_produtos');
