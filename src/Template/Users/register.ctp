...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <fieldset>
        <?php
            echo $this->Form->control('name', ['class' => 'form-control', 'Placeholder' => 'Name', 'label' => false]);
            echo '<br>';
            echo $this->Form->control('username', ['class' => 'form-control', 'Placeholder' => 'Username', 'label' => false]);
            echo '<br>';
            echo $this->Form->control('email', ['class' => 'form-control', 'Placeholder' => 'Email', 'label' => false]);
            echo '<br>';
            echo $this->Form->control('password', ['class' => 'form-control', 'Placeholder' => 'Password', 'label' => false]);
            echo '<br>';
            echo $this->Form->control('confirm_password', ['type' => 'password', 'class' => 'form-control', 'Placeholder' => 'Password', 'label' => false]);
            echo '<br>';
