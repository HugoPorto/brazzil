...
<div class="row">
    <div class="col-6">
        <div class="card">
            ...
            <div class="card-body">
                <table id="users" class="table table-bordered table-striped" style="font-size: 13px">
    ...
    <div class="col-6">
        <div class="card">
            ...
            <div class="card-body">
                <table id="users_root" class="table table-bordered table-striped" style="font-size: 13px">
                    <thead class="table-dark">
                        <tr>
                            <th>Código</th>
                            <th>Nome</th>
...
<div class="row">
    <div class="col-6">
        <div class="card">
            ...
            <div class="card-body">
                <table id="users_admin" class="table table-bordered table-striped" style="font-size: 13px">
                    <thead class="table-dark">
                        <tr>
                            <th>Código</th>
                            <th>Nome</th>
